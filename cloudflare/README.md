...
SonicScout2.0 uses two production Cloudflare Workers and two separate private R2 buckets.
...
- URL: `https://sonicscout2-support.sensoredrooster-com.workers.dev`
- Health: `https://sonicscout2-support.sensoredrooster-com.workers.dev/health`
- Upload: `https://sonicscout2-support.sensoredrooster-com.workers.dev/upload`
...
- Worker: `sonicscout2-share`
- URL: `https://sonicscout2-share.sensoredrooster-com.workers.dev`
- Health: `https://sonicscout2-share.sensoredrooster-com.workers.dev/health`
