# SonicScout2.0 Documentation Index

This folder contains the maintained operational documentation for SonicScout2.0.
...
|---|---|---|
| Support diagnostics | `sonicscout2-support` | `sonicscout2-support-logs` |
| Tester Share | `sonicscout2-share` | `sonicscout2-share` |

- Support: `https://sonicscout2-support.sensoredrooster-com.workers.dev`
...
- [SUPPORT.md](SUPPORT.md) — WPF support diagnostics, privacy, and production support service.
- [TESTER_SHARE.md](TESTER_SHARE.md) — Authenticated tester/admin file portal behavior and maintenance.
- [../tools/SonicScoutCSharp/README_CSHARP.md](../tools/SonicScoutCSharp/README_CSHARP.md) — C# desktop app build/run notes.
